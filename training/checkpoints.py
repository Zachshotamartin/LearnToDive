...
ENV_SETTINGS=['n','minimum_heights','boundary_rate','execution_weight','ascent_weight','launch_speed_weight','entry_geometry_weight','skill_ids','heights','training']
...
def capture_environment(env):
 ...
 return {'settings':{k:copy.deepcopy(getattr(env,k))for k in ENV_SETTINGS},
